...
# Form for new user registratoin
    ...
    def validate_username(self, username):
        ...
        if user:
            raise ValidationError('Userame already taken. Please choose another one.')
...
class TicketForm(FlaskForm):
    # The form for creating and editing tickets

    title = StringField('Title', validators=[DataRequired(), Length(max=100, message='Title must be less than 100 characters')])
